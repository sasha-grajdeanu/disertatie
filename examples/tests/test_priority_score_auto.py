...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(5001, 5001, 0, 5, id="('age gte 18) and (('income lte 5000) or ('flags lte 0)) and (('income gt 3000) or ('flags gt 2))"),
        pytest.param(18, 3000, 2, 1, id="('age gte 18) and (('income lte 5000) or ('flags lte 0)) and (('income lte 3000) and ('flags lte 2))"),
    ],
)
