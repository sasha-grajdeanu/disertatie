...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(-1, 1, -1, -1, id="('count gt 0) and ('total lt 0) and ('count neq 0) and (0 / 'count gt 'limit)"),
        pytest.param(-1, 1, 0, 0, id="('count gt 0) and ('total lt 0) and ('count neq 0) and (0 / 'count lte 'limit)"),
        pytest.param(0, 1, -1, -1, id="('count gt 0) and ('total gte 0) and ('count neq 0) and ('total / 'count gt 'limit)"),
